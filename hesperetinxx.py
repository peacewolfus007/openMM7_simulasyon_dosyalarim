...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('hesperetinxx.prmtop')
inpcrd = app.AmberInpcrdFile('hesperetinxx.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('hesperetinxx.nc', 1000))
simulation.saveCheckpoint('hesperetinxx.chk')
