...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('receptor.prmtop')
inpcrd = app.AmberInpcrdFile('receptor.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('receptor.nc', 1000))
simulation.saveCheckpoint('receptor.chk')
