...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('morin_4_chainb.prmtop')
inpcrd = app.AmberInpcrdFile('morin_4_chainb.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('morin_4_chainb.nc', 1000))
simulation.saveCheckpoint('morin_4_chainb.chk')
