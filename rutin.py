...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('rutin.prmtop')
inpcrd = app.AmberInpcrdFile('rutin.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('rutin.nc', 1000))
simulation.saveCheckpoint('rutin.chk')
