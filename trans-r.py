...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('trans-r.prmtop')
inpcrd = app.AmberInpcrdFile('trans-r.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('trans-r.nc', 1000))
simulation.saveCheckpoint('trans-r.chk')
