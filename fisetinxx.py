...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('fisetinxx.prmtop')
inpcrd = app.AmberInpcrdFile('fisetinxx.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('fisetinxx.nc', 1000))
simulation.saveCheckpoint('fisetinxx.chk')
