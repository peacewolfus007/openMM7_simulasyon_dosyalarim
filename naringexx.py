...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('naringexx.prmtop')
inpcrd = app.AmberInpcrdFile('naringexx.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('naringexx.nc', 1000))
simulation.saveCheckpoint('naringexx.chk')
