...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('isoquerxx.prmtop')
inpcrd = app.AmberInpcrdFile('isoquerxx.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('isoquerxx.nc', 1000))
simulation.saveCheckpoint('isoquerxx.chk')
