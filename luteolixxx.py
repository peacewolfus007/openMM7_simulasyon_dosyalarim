...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('luteolixxx.prmtop')
inpcrd = app.AmberInpcrdFile('luteolixxx.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('luteolixxx.nc', 1000))
simulation.saveCheckpoint('luteolixxx.chk')
