...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('coumarix.prmtop')
inpcrd = app.AmberInpcrdFile('coumarix.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('coumarix.nc', 1000))
simulation.saveCheckpoint('coumarix.chk')
