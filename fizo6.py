...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('fizo_mass.prmtop')
...
total_steps = 50000000  # 100 ns için toplam adım sayısı (2 fs/adım)
checkpoint_interval = 1000000  # Her 2 ns için adım sayısı

for step in range(0, total_steps, checkpoint_interval):
    start_time = time.time()
    
    current_ns = (step + checkpoint_interval) * 4 / 1000000  # ns cinsinden mevcut zaman
