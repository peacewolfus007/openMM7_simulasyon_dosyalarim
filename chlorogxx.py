...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('chlorogxx.prmtop')
inpcrd = app.AmberInpcrdFile('chlorogxx.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('chlorogxx.nc', 1000))
simulation.saveCheckpoint('chlorogxx.chk')
