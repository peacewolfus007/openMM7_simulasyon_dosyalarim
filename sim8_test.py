...
trajectory = md.load('output7.nc', top='complex_su.prmtop') #1 arttır girdi
...
simulation.loadCheckpoint('checkpoint7.chk') #1 arttır girdi

# Önceki simülasyondan son koordinatları yükle
simulation.context.setPositions(last_frame.xyz[0] * nanometers)

# Veri kaydetme
simulation.reporters.append(NetCDFReporter('output8.nc', 1000)) #1 arttır çıktı
simulation.saveCheckpoint('checkpoint8.chk') #1 arttır çıktı
