...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('sinapin.prmtop')
inpcrd = app.AmberInpcrdFile('sinapin.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('sinapin.nc', 1000))
simulation.saveCheckpoint('sinapin.chk')
