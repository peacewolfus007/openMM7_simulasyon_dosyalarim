...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('orobol_chainb.prmtop')
inpcrd = app.AmberInpcrdFile('orobol_chainb.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('orobol_chainb.nc', 1000))
simulation.saveCheckpoint('orobol_chainb.chk')
