...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('trans-c.prmtop')
inpcrd = app.AmberInpcrdFile('trans-c.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('trans-c.nc', 1000))
simulation.saveCheckpoint('trans-c.chk')
