...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('scutell.prmtop')
inpcrd = app.AmberInpcrdFile('scutell.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('scutell.nc', 1000))
simulation.saveCheckpoint('scutell.chk')
