...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('trans-f.prmtop')
inpcrd = app.AmberInpcrdFile('trans-f.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('trans-f.nc', 1000))
simulation.saveCheckpoint('trans-f.chk')
