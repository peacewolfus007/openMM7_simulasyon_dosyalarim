...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('catechixx.prmtop')
inpcrd = app.AmberInpcrdFile('catechixx.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('catechixx.nc', 1000))
simulation.saveCheckpoint('catechixx.chk')
