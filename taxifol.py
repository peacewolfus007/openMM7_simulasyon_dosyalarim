...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('taxifol.prmtop')
inpcrd = app.AmberInpcrdFile('taxifol.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('taxifol.nc', 1000))
simulation.saveCheckpoint('taxifol.chk')
