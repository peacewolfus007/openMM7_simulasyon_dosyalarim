...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('o-couma.prmtop')
inpcrd = app.AmberInpcrdFile('o-couma.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('o-couma.nc', 1000))
simulation.saveCheckpoint('o-couma.chk')
