...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('hesperidin.prmtop')
inpcrd = app.AmberInpcrdFile('hesperidin.crd')
...
for step in range(50000): #(her adım 2 fs)
    simulation.step(2)

# Veri kaydetme
simulation.reporters.append(NetCDFReporter('hesperidin.nc', 1000))
simulation.saveCheckpoint('hesperidin.chk')
