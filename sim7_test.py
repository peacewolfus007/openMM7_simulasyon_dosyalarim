...
trajectory = md.load('output6.nc', top='complex_su.prmtop') #1 arttır girdi
...
simulation.loadCheckpoint('checkpoint6.chk') #1 arttır girdi

# Önceki simülasyondan son koordinatları yükle
simulation.context.setPositions(last_frame.xyz[0] * nanometers)

# Veri kaydetme
simulation.reporters.append(NetCDFReporter('output7.nc', 1000)) #1 arttır çıktı
simulation.saveCheckpoint('checkpoint7.chk') #1 arttır çıktı
