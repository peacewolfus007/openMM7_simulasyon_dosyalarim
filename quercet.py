...
# Dosyaları yükleme
prmtop = app.AmberPrmtopFile('quercet.prmtop')
inpcrd = app.AmberInpcrdFile('quercet.crd')
...
# Veri kaydetme
simulation.reporters.append(NetCDFReporter('quercet.nc', 1000))
simulation.saveCheckpoint('quercet.chk')
